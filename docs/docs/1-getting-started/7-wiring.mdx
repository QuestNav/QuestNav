...
:::tip
Create a simple checklist to verify all connections before matches. A quick visual inspection can catch loose cables before they cause problems. See the [Pre-Match Checklist](./pre-match-checklist) for a ready-made list.
:::
