...
namespace QuestNav.Config
{
    ...
    {
        private static readonly string dbPath = Path.Combine(Application.persistentDataPath, "config.db");
        ...
        public async Task setTeamNumberAsync(int teamNumber)
        {
            ...
            {
                QueuedLogger.LogError("Attempted to write a non-valid team number to the config! Aborting...");
                return;
            }
        ...
        public async Task setDebugIpOverrideAsync(string ipOverride)
        {
            ...
            {
                QueuedLogger.LogError("Attempted to write a non-valid debug IP override to the config! Aborting...");
                return;
            }
        ...
        {
            return teamNumber is >= QuestNavConstants.Network.MIN_TEAM_NUMBER
